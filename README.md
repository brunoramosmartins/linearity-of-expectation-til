...
- [x] **Phase 4 — Budget Modelling Simulation:** 50-person team, LogNormal salaries, Gaussian copula, correlation sweep.
- [ ] **Phase 5 — TIL Writing** (in progress): final article in Hook / Insight / Example / Takeaway format.
